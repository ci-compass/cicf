...
A note to the scientists and the mathematicians: LaTeX is another
markup language. Markdown is a much, much simpler one.  If you need
to, you can convert your notebooks into LaTeX using `jupyter
nbconvert` command. For example:

```
jupyter nbconvert 1-introduction.ipynb --to latex
```
