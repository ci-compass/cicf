---
title: A Very Quick Tour of Python
jupyter: python3
---

In this notebook, we'll look at some of the language features of
python and how to use them. **This entire notebook assumes you have
some programming experience already**. This might be in Java,
Javascript, C, C++, or even (shudder) Fortran.

Just kidding. I have *wonderful* memories of Fortran. And even today,
if you absolutely need that last half a percent of efficiency, it's
the way to go.

In the **Introduction** notebook, we ran a print statement and did
some basic arithmetic. Click in the next cell with the example code
...
That code could be in almost any language - virtually all "procedural
programming" languages overwhelmingly work the same way.
...
positive to negative 9 billion billon, give or take a little. If youb
