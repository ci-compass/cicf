...
We will discuss modules later.  For now, just bear in mind that these
facilities are part of Python's standard library, which is a
collection of useful and commonly used things.  You will use the
standard library a lot if you use Python.
